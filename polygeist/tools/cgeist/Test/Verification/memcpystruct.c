...
// CHECK:   func @copy(%arg0: memref<?x!polygeist.struct<(i32, i32)>>, %arg1: !llvm.ptr<i8>) attributes {llvm.linkage = #llvm.linkage<external>}
// CHECK-DAG:      %false = arith.constant false
// CHECK-DAG:      %c8_i64 = arith.constant 8 : i64
// CHECK-DAG:      %0 = llvm.bitcast %arg0 : !llvm.ptr<!polygeist.struct<(i32, i32)>> to !llvm.ptr<i8>
